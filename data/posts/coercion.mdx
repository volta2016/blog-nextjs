...
## Hay que tener la sigiente reglas

- <span className="list-icon">✔️</span> objects evaluado como <b>true</b>
...
- <span className="list-icon">✔️</span> numbers evalúa <b>false</b> si +0, -0, o
  NaN, para los demás <b>true</b>
...
Si ejecutas en la consola del navegador este código la salida nos muestra **true**
...
<i>
  🚧 "Cuando JS compara dos valores a través de ==, uno de los valores puede
  sufrir coerción"
</i>
...
👉 <i>Secretamente el 0 en string se convertio a numero </i>

## 2- Las matrices también hacen ceorción
...
👉 ToPrimitive ([])// "" da una cadena vacía 2- Entonces ToNumber ("") da 0
...
- <span className="list-icon">✔️</span> cero "string" no el igual a un string vacío
